...
# --- File Paths & Directories (UPDATED FOR NEW STRUCTURE) ---
# SCRIPT_DIR is where this file actually lives: scrapers/facebook/
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
# PROJ_ROOT anchors up one level: scrapers/
PROJ_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, '..'))

# Relative to SCRIPT_DIR (keep these close to the scraper logic)
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "housing_posts_data") # scrapers/facebook/housing_posts_data/[cite: 15]
METADATA_DIR = os.path.join(SCRIPT_DIR, "groups_metadata")  # scrapers/facebook/groups_metadata/[cite: 15]
GROUPS_CONFIG_FILE = os.path.join(SCRIPT_DIR, "groups_config.json") # scrapers/facebook/groups_config.json[cite: 17]
