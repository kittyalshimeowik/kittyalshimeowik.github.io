...
# Point two levels up to project root: scrapers/processors/__tests__/ -> armenia-real-estate-website/
...
class TestDataGenerator(unittest.TestCase):
    ...
    def test_price_conversion_boundary_zero_and_negative(self):
        from scrapers.processors.generate_site_data import normalize_and_convert_prices
        # Test $0 price
    ...
    def test_sanitize_filename_special_characters(self):
        from scrapers.processors.generate_site_data import sanitize_filename
